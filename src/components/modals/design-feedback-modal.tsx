    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        ...
        <div className="space-y-6">
          <RadioGroup value={choice} onValueChange={(value) => setChoice(value as FeedbackChoice)}>
          ...
          <div className="flex gap-3">
            <Button
              variant="outline"
              onClick={() => onOpenChange(false)}
              className="flex-1 border-[#E5EAEA] text-[#93A3A5] hover:bg-[#F3F7F7]"
            >
              Plus tard
            </Button>
            <Button
              ...
              className="flex-1 bg-[#2F4B4E] hover:bg-[#405F62] text-white"
            >
