      ...
      <div className="pliiz-list">
        <div className="text-center space-y-4">
          <div className="relative inline-block">
            ...
            <button 
              ...
              className="absolute -right-2 -bottom-2 w-10 h-10 rounded-full bg-gradient-to-r from-[#ff9c6b] to-[#ff7cab] text-white shadow-lg hover:opacity-90 transition-all grid place-items-center"
        ...
        {!prefsLoading && preferences && (
          <div className="space-y-4">
            <h3 className="text-xl font-bold mb-4">Mes préférences</h3>
        ...
        <Card>
          <div className="p-4 text-center space-y-3">
              ...
              <div className="flex gap-2">
                <Button className="flex-1 h-10 flex items-center justify-center" onClick={() => setCurrentScreen('share-profile')}>
                  <Share2 className="h-4 w-4 mr-2" />
                  <span>PARTAGER</span>
                </Button>
                <Button variant="secondary" className="w-10 h-10 p-0 flex items-center justify-center" onClick={() => setCurrentScreen('qr-code')}>
