      ...
      <div className="pb-6">
        <div className="max-w-4xl mx-auto">
          ...
          <header className="text-center mb-6 mt-2">
            ...
            <Card className="bg-gradient-to-br from-white/95 to-white/90 backdrop-blur-md p-6 max-w-sm mx-auto space-y-4 shadow-2xl border-2 border-white/40 rounded-[24px] mt-6">
              <p className="text-[#5b3bb8] text-sm leading-relaxed font-medium">
                Connectez-vous pour voir le profil complet et envoyer une demande de contact
              </p>
              <Button 
                onClick={() => navigate('/login')} 
                className="w-full bg-gradient-to-r from-[#ff9c6b] to-[#ff7cab] hover:opacity-90 text-white font-bold text-sm py-5 rounded-full shadow-lg"
              >
                SE CONNECTER
              </Button>
            </Card>
          ...
          <header className="text-center mb-6 mt-2">
            ...
            <Card className="bg-gradient-to-br from-white/95 to-white/90 backdrop-blur-md p-6 max-w-sm mx-auto space-y-4 shadow-2xl border-2 border-white/40 rounded-[24px] mt-6">
              ...
              <Button 
                ...
                className="w-full bg-gradient-to-r from-[#ff9c6b] to-[#ff7cab] hover:opacity-90 text-white font-bold text-sm py-5 rounded-full shadow-lg disabled:opacity-50"
              >
              ...
              {giftIdeas.map((item, index) => (
                <Card key={index} className="p-[10px] flex flex-col items-center space-y-3 rounded-[24px]" data-gift-label={item}>
                  ...
                  <p className="text-sm text-center text-foreground font-medium line-clamp-2 min-h-[2.5rem]">
                   ...
                   <button
                     className="w-full py-3 px-6 rounded-full font-bold text-white text-base bg-gradient-to-r from-[#ff7cab] to-[#ff9c6b] hover:opacity-90 transition-opacity disabled:opacity-50"
                     aria-label={`Offrir ${item}`}
                     disabled={!item?.trim()}
                     data-offer-label={item}
                   >
