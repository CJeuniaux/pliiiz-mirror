...
export function UnsplashMentionsModal({ open, onOpenChange }: UnsplashMentionsModalProps) {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-white rounded-2xl shadow-lg border border-gray-100 max-w-2xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
        ...
        <div className="space-y-6">
          ...
          <div className="text-xs text-muted-foreground p-3 bg-muted/50 rounded-lg">
            <p className="font-medium mb-2">Conformité avec les guidelines Unsplash :</p>
            <ul className="space-y-1 list-disc list-inside">
              <li>Images affichées via hotlink uniquement (pas de téléchargement local)</li>
              <li>Attribution visible pour chaque photographe</li>
              <li>Liens UTM vers les profils des photographes</li>
              <li>Comptabilisation des téléchargements via l'API</li>
              <li>Respect des conditions d'utilisation Unsplash</li>
            </ul>
          </div>
