        ...
        <Card className="w-full max-w-md bg-white">
          <CardContent className="p-8 space-y-6">
            <div className="text-center mb-8">
              <h1 className="title-brand">Mot de passe oublié</h1>
            ...
            <div className="space-y-3">
              <Label htmlFor="resetEmail" className="font-inter font-medium text-foreground">Email</Label>
              <Input
                id="resetEmail"
                type="email"
                value={resetEmail}
  ...
  return (
    <ScreenFixedBG isAuth={false} topGap={50} padH={24} padB={24}>
      ...
      <Card className="w-full max-w-md bg-white">
        <CardContent className="p-8 space-y-6">
          <div className="text-center mb-8">
            <h1 className="title-brand">Connexion</h1>
            <p className="text-muted-foreground mt-3 text-base">
          ...
          <div className="space-y-3">
            <Label htmlFor="email" className="font-inter font-medium text-foreground">Email</Label>
            <Input
              id="email"
              type="email"
              value={email}
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              <Label htmlFor="password" className="font-inter font-medium text-foreground">Mot de passe</Label>
              <button 
                type="button"
      ...
      {/* Footer with mentions link */}
      <footer className="mt-8 text-center">
        <button
          onClick={() => setMentionsOpen(true)}
          className="text-white/70 hover:text-white text-sm hover:underline transition-colors duration-200"
        >
          Mentions légales & crédits photo
        </button>
      </footer>
