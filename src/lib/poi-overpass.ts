...
export const TYPE_ALIASES: Record<string, string> = {
  ...
  "bijou": "bijoux", "bijoux": "bijoux",
  "montre": "horlogerie", "montres": "horlogerie", "watch": "horlogerie",
...
export function resolveTypeFromIdea(input: string, fallback: string = "cadeau"): string {
  ...
  if (/vin|cav|champagne|bi(e|è)re|whisk|spirit/.test(x)) return "caviste";
  ...
  if (/bijou|collier|bracelet|bague/.test(x)) return "bijoux";
  if (/montre|watch/.test(x)) return "horlogerie";
  ...
  if (/sport|outdoor|running|rando/.test(x)) return "sport";
