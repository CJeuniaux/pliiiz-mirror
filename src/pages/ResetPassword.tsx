        ...
        <Card className="bg-white shadow-2xl">
          <CardContent className="p-8 space-y-6">
            <div className="text-center space-y-2">
              <h1 className="text-3xl font-bold text-gray-700">Réinitialiser le mot de passe</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-2">
                <label className="block text-gray-700 font-medium text-sm">Nouveau mot de passe</label>
                <Input
                  type="password"
                  value={password}
              ...
              <div className="space-y-2">
                <label className="block text-gray-700 font-medium text-sm">Confirmer le mot de passe</label>
                <Input
                  type="password"
                  value={confirm}
