...
-- First, drop the function that depends on v_public_profile_source
DROP FUNCTION IF EXISTS public.build_public_payload_v2(v_public_profile_source);
...
-- Recreate my_contacts_view with security_invoker = true
...
-- Recreate v_public_profile_source with security_invoker = true
...
-- Recreate v_unsplash_rebuild_stats with security_invoker = true
...
-- Recreate the build_public_payload_v2 function with the new view type
