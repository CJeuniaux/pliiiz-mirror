-- Création des tables pour le système de regift selon spécifications
...
CREATE TABLE IF NOT EXISTS public.regifts (
  ...
  to_contact_id UUID NOT NULL, -- Référence vers un contact (table contacts)
