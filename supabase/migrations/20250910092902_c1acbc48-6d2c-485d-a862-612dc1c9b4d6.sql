-- HOTFIX v4: Fix signup DB error due to missing gen_random_bytes by using extensions schema
-- Ensure pgcrypto is available under the extensions schema
CREATE EXTENSION IF NOT EXISTS pgcrypto WITH SCHEMA extensions;

-- Replace handle_new_user to use extensions.gen_random_bytes
